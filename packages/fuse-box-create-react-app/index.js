...
// breaking changes.
//
// The only job of fuse-box-create-react-app is to init the repository and then
...
if (currentNodeVersion.split('.')[0] < 6) {
  console.error(
    chalk.red(
      ...
      'Fuse-Box Create React App requires Node 6 or higher. \n' +
...
function getInstallPackage(version) {
  var packageToInstall = 'fuse-box-react-scripts';
...
function checkAppName(appName) {
  ...
  var devDependencies = ['fuse-box-react-scripts'];
