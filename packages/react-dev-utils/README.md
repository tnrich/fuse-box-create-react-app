...
See [#186](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/186) for details.
...
module.exports = {
  ...
  plugins: [
    ...
    // See https://github.com/offgridnetworks/fuse-box-create-react-app/issues/186
